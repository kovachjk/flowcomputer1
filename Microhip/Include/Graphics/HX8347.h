...
*********************************************************************/
        ...
        #error This driver does not supports this resolution. Horisontal resolution must be 240 pixels.
    #endif
    #if (DISP_VER_RESOLUTION != 320)
        #error This driver does not supports this resolution. Vertical resolution must be 320 pixels.
    #endif
...
*********************************************************************/
        ...
        #error This driver does not support this orientation.
    #endif
...
*********************************************************************/
    #if (COLOR_DEPTH != 16)
        #error This driver does not support this color depth. It should be 16.
    #endif
